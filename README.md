<p align="right">
  <img src="https://raw.githubusercontent.com/PowerEssentials/PowerEssentials/stable/img/indonesia.png" height="23px">
</p>

<p align="center">
  <a href="https://github.com/PowerEssentials">
    <img src="https://raw.githubusercontent.com/PowerEssentials/PowerEssentials/stable/icon.png" width="25%">
  </a>
</p>

<h1 align="center">PowerEssentials Bukkit/Spigot/Paper</h1>
<p align="center"><strong>The ultimate Bukkit/Spigot/Paper plugin to streamline server management and enhance gameplay.</strong></p>
...
| `/mute <player> <time: 10m> [reason]`, `/unmute [player]`            | Mute a player.                                                                     | ⌛     |
| `/tempban <player> <time: 10m> [reason]`                             | Temporarily ban a player.                                                          | ⌛     |
| `/bancommand <command> [world]`                                      | Ban a command in a specific world.                                                 | ⌛     |
| `/lightning [player]`                                                | Strike a player with lightning.                                                    | ⌛     |
| `/staffchat`                                                         | Enter staff chat mode.                                                             | ⌛     |
| `/walkspeed <speed: 1.5>`                                            | Adjust walk speed.                                                                 | ⌛     |
| `/flyspeed <speed: 1.5>`                                             | Adjust fly speed.                                                                  | ⌛     |
| `/renameitem <name>`                                                 | Rename the item in your hand.                                                      | ⌛     |
| `/itemlore <name>`                                                   | Set lore for the item in your hand (`use {line} to create a new line`).            | ⌛     |
| `/enchants <enchant:level>[]`                                        | Enchant multiple items in your hand (e.g., `/enchants unbreaking:2 thorns:1`).     | ⌛     |
| `/pvptoggle`                                                         | Toggle PvP mode on or off.                                                         | ⌛     |
| `/antitp`                                                            | Enable Anti-Teleport.                                                              | ⌛     |
| `/nightvision`                                                       | Enable Night Vision mode.                                                          | ⌛     |
...
- [GitHub Repository](https://github.com/PowerEssentials/PowerEssentials-Bukkit)
